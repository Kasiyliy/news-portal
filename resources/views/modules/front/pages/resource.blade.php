                ...
                <div class="resource__contact pt-5 pb-5">
                    ...
                    <div class="d-flex">
                        ...
                        @if($mapRegion->youtube)
                            <a href="{{$mapRegion->youtube}}"> <i class="resource__social fa fa-2x mr-3 fa-youtube"></i></a>
                        @endif
                        @if($mapRegion->twitter)
                            <a href="{{$mapRegion->twitter}}"> <i class="resource__social fa fa-2x mr-3 fa-twitter"></i></a>
                        @endif
                    </div>
