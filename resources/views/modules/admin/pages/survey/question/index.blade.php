        ...
        <div class="col-md-12 mb-5">
            <div class="card h-100">
                <header class="card-header">
                    <a href="{{route('survey.index')}}" class="btn btn-outline-primary mt-1 mb-4"><i class="ti ti-arrow-left"></i> Назад</a>
                    <h2 class="h4 card-header-title">Вопросы : {{$survey->title}}</h2>
                    <a href="{{route('survey.question.create', ['survey_id' => $survey->id])}}" class="btn btn-outline-primary mt-3">Добавить <i class="ti ti-plus"></i></a>
                </header>
                            ...
                            @foreach($questions as $question)
                                <tr>
                                    ...
                                    <td> @if($question->required)
                                        ...
                                        @endif</td>
                                    <td class>
                                        <a href="{{route('survey.question.edit', ['id' => $question->id])}}" class="btn btn-outline-primary btn-sm"><i class="ti ti-pencil"></i>
                                        </a>
...
{{--                                                        <form method="post" action="{{route('business.content.delete', ['id' => $content->id])}}">--}}
{{--                                                            {{csrf_field()}}--}}
