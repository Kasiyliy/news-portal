        ...
        <div class="col-md-12 mb-5">
            <div class="card h-100">
                <header class="card-header">
                    <h2 class="h4 card-header-title">Группы</h2>
                    <a href="{{route('groups.create')}}" class="btn btn-outline-primary mt-3">Добавить <i class="ti ti-plus"></i></a>
                ...
                <div class="card-body pt-0">
                    @if($groups->items())
                        <table class="table table-hover table-light text-center">
                            ...
                            @foreach($groups as $group)
                                <tr>
                                    ...
                                    <td >
                                        <a href="{{route('groups.edit', ['id' => $group->id])}}" class="btn btn-outline-primary btn-sm"><i class="ti ti-pencil"></i>
                                        </a>
                                        <button class="btn btn-outline-danger btn-sm" data-toggle="modal"
                                                data-target="#delete{{$group->id}}"><i class="ti ti-trash"></i>
                                        </button>
                                        <div class="modal modal-backdrop" id="delete{{$group->id}}" tabindex="-1"
                        ...
                        {{$groups->links()}}
                    @else <h6>У вас пока нет групп!</h6>
                    @endif
                </div>
            </div>
        </div>
