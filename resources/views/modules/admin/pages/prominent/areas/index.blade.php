                                ...
                                <tr>
                                    ...
                                    <td class="d-inline-block">
                                        <button class="btn btn-outline-primary btn-sm" data-toggle="modal"
                                                data-target="#edit{{$area->id}}"><i class="ti ti-pencil"></i>
                                        </button>
...
{{--                                        </button>--}}
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <form method="post" action="{{route('prominent.area.delete', ['id' => $area->id])}}">
                                                            {{csrf_field()}}
                                ...
                                <div class="modal modal-backdrop" id="edit{{$area->id}}" tabindex="-1"
                                     role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-backdrop="false">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <form action="{{route('prominent.area.update', ['id' => $area->id])}}" method="post">
                                                    <x-admin.input-form-group-list
                                                        :errors="$errors"
                                                        :elements="\App\Http\Forms\Web\V1\System\Content\Prominent\ProminentAreaWebForm::inputGroups($area)"/>
                        ...
                        {{$areas->links()}}
                    @else <h6>У вас пока нет районов!</h6>
                    @endif
                </div>
            </div>
        </div>
    ...
    <div class="modal modal-backdrop" id="add" tabindex="-1"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title w-100" id="myModalLabel">Добавить район</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form action="{{route('prominent.area.store')}}" method="post">
                        <x-admin.input-form-group-list
                            :errors="$errors"
