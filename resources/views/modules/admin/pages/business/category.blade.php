...
@section('content')
<h1 class="h2 mb-2">Бизнес подкатегории: {{$parent_category->name}}</h1>
    ...
    <div class="col-md-12 mb-5">
        <div class="card h-100">
            <header class="card-header">
                ...
                <h2 class="h4 card-header-title">Бизнес подкатегории: {{$parent_category->name}}</h2>
                ...
                <table class="table table-hover table-light text-center">
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <form method="post" action="{{route('business.category.delete', ['id' => $category->id])}}">
                                                {{csrf_field()}}
                    ...
                    <div class="modal modal-backdrop" id="editCategory{{$category->id}}" tabindex="-1"
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h4 class="modal-title w-100" id="myModalLabel">Редактировать подкатегорию</h4>
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                        <span aria-hidden="true">&times;</span>
                                    </button>
                                </div>
                                <div class="modal-body">
                                    ...
                                    <form action="{{route('business.category.update', ['id' => $category->id])}}" method="post" enctype="multipart/form-data">
                                        <x-admin.input-form-group-list
                                            :errors="$errors"
                                            :elements="\App\Http\Forms\Web\V1\System\Content\Business\BusinessChildCategoryWebForm::inputGroups($category)"/>
...
<div class="modal modal-backdrop" id="addCategory" tabindex="-1"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title w-100" id="myModalLabel">Добавить подкатегорию</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form action="{{route('business.category.store',['category_id' => $category_id])}}" method="post" enctype="multipart/form-data">
                    <x-admin.input-form-group-list
                        :errors="$errors"
