        ...
        <div class="col-md-12 mb-5">
            <div class="card h-100">
                <header class="card-header">
                    <a href="{{route('business.content.index', ['category_id' => $category_id])}}" class="btn btn-outline-primary mt-1 mb-4"><i class="ti ti-arrow-left"></i> Назад</a>
                    <h2 class="h4 card-header-title">Бизнес контент</h2>
                </header>
                <div class="card-header border-dark">
                    <img src="{{asset($content->image_path)}}" >
                </div>
                <div class="card-body pt-0">
                    <form action="{{route('business.content.update', ['id' => $content->id])}}" method="post" enctype="multipart/form-data">
