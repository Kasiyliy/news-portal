...
@section('content')
    <h1 class="h2 mb-2">Форум категории</h1>
        ...
        <div class="col-md-12 mb-5">
            <div class="card h-100">
                <header class="card-header">
                    <h2 class="h4 card-header-title">Форум категории</h2>
                            ...
                            @foreach($categories as $category)
                                <tr>
                                    ...
                                    <td >
                                        ...
                                        <a href="{{route('forum.category.index', ['category_id' => $category->id])}}"
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <form method="post" action="{{route('forum.delete', ['id' => $category->id])}}">
                                                            {{csrf_field()}}
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <form action="{{route('forum.update', ['id' => $category->id])}}" method="post" enctype="multipart/form-data">
                                                    <x-admin.input-form-group-list
                                                        :errors="$errors"
                                                        :elements="\App\Http\Forms\Web\V1\System\Content\Forum\ForumCategoryWebForm::inputGroups($category)"/>
