...
@section('content')
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Программа</li>
        </ol>
    </nav>
    <div class="row">
        <div class="col-md-12 mb-5">
            <div class="card h-100">
                <header class="card-header">
                    ...
                    <h2 class="h4 card-header-title">Редактирование программы</h2>
                </header>
                <div class="card-body pt-0">
                    <form action="{{route('programs.update', ['id' => $program->id])}}" method="post">
                        <x-admin.input-form-group-list
                            :errors="$errors"
                            :elements="$program_web_form"/>
